...
define(['N/url', 'N/log', 'N/http', 'N/https', 'N/search', 'N/runtime', 'N/record', 'N/translation'],
    ...
    function (url, log, http, https, search, runtime, record, translation) {
        ...
        function pageInit(context) {
            console.log("tsa_vs_check_buying_subs:interUnit pageinit - call lineInit")

            console.log("tsa_vs_check_buying_subs:pageinit: CLASS");
            var unit_division = context.currentRecord.getValue({ fieldId: "custbody_rsm_uni_division" });
            if (unit_division) {
                console.log("tsa_vs_check_buying_subs:pageInit: unit_division=" + unit_division);
                ...
                console.log("tsa_vs_check_buying_subs:shared_key_lookup response=" + JSON.stringify(response))
                console.log("tsa_vs_check_buying_subs:shared_key_lookup returned UNIT division shared key id: " + response.body)
                context.currentRecord.setValue({ fieldId: "custbody_unit_div_shared_key", value: response.body });
            }

            console.log("tsa_vs_check_buying_subs: postSourcing: RELPARTY context.fieldId=" + context.fieldId);
            var rp_division = context.currentRecord.getValue({ fieldId: "custbody_rsm_rp_division" });
            if (rp_division) {
                console.log("tsa_vs_check_buying_subs:postSourcing: rp_division=" + rp_division);
                var suitletURL = url.resolveScript({
                    scriptId: 'customscript_tsa_vs_rp_shared_key_sl20',
                    deploymentId: 'customdeploy_tsa_vs_rp_shared_key_sl20',
                    returnExternalUrl: true,
            ...
            try {
                ...
                switch (context.fieldId) {
                    case "class": //custbody_unit_div_shared_key custbody_relparty_div_shared_key , custbody_rsm_uni_division custbody_rsm_rp_division
                        console.log("tsa_vs_check_buying_subs: postSourcing: CLASS context.fieldId=" + context.fieldId);
                        var unit_division = context.currentRecord.getValue({ fieldId: "custbody_rsm_uni_division" });
                        if (!unit_division) break;
                        console.log("tsa_vs_check_buying_subs:postSourcing: unit_division=" + unit_division);
                        var suitletURL = url.resolveScript({
                            scriptId: 'customscript_tsa_vs_rp_shared_key_sl20',
                            deploymentId: 'customdeploy_tsa_vs_rp_shared_key_sl20',
                            returnExternalUrl: true,
        ...
        */
        function validateLine(scriptContext) {
            ...
            try {
                ...
                console.log("tsa_vs_check_buying_subs:check_buying_subs::VL fired");
                var currentRecord = scriptContext.currentRecord;

                //Get invoice subsidiary
                var subsidiary = currentRecord.getValue({ fieldId: "subsidiary" });
                console.log("tsa_vs_check_buying_subs:check_buying_subs::VL - subsidiary=" + subsidiary);
                ...
                console.log("tsa_vs_check_buying_subs:check_buying_subs::SR - csegSubsidiary=" + csegSubsidiary);
                ...
                if (parseFloat(subsidiary) != parseFloat(csegSubsidiary)) {
                    ...
                    console.log("tsa_vs_check_buying_subs:check_buying_subs::SR - response:" + JSON.stringify(response));
                    ...
                    var response = https.get({ url: suitletURL });
                    console.log("tsa_vs_check_buying_subs:check_buying_subs::SR - response:" + JSON.stringify(response));
                    console.log("tsa_vs_check_buying_subs:check_buying_subs::SR - returned value:" + response.body);

                    var lineSubsIsValid = parseInt(response.body);

                    console.log("tsa_vs_check_buying_subs:check_buying_subs::SR - lineSubsIsValid:" + lineSubsIsValid);
                ...
                console.log("tsa_vs_check_buying_subs:check_buying_subs::VL - Error message=" + e);
                log.debug("tsa_vs_check_buying_subs:check_buying_subs::VL - ERROR", e);
            }
            finally {
            }
        }
        ...
        function fieldChanged(scriptContext) {
            ...
            try {
                ...
                if (scriptContext.fieldId == "custbody_cseg_tsa_relatedpar" || scriptContext.fieldId == "currency" || scriptContext.fieldId == "custbody_tsa_inter_unit") {
                    ...
                    var suitletURL = url.resolveScript({
                        scriptId: 'customscript_tsa_vs_supplr_curr_chk_sl20',
                        deploymentId: 'customdeploy_tsa_vs_supplr_curr_chk_sl20',
                        returnExternalUrl: false,
                    ...
                    console.log("tsa_vs_check_buying_subs::fieldChanged() supplierId=" + supplierId + ", currency=" + currency + ", Currency is missing=" + (response.body == "F" ? "true" : "false")); 
                }
            }
            catch (e) {
                console.log("tsa_vs_check_buying_subs::fieldChanged() Error message=" + e);
            }
            finally {
            }
        }
