    ...
    function billAfterSubmit(context) {
	   try {
           ...
           if(context.type === context.UserEventType.CREATE || context.type === context.UserEventType.EDIT || context.type === context.UserEventType.APPROVE){
               ...
               var inter_unit_flag = context.newRecord.getValue("custbody_tsa_inter_unit");
               var iu_auto_generated_flag = context.newRecord.getValue("custbody_tsa_vs_ce_auto_generated");
               if(!inter_unit_flag && !iu_auto_generated_flag){
