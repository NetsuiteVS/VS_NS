...
define(['N/record', 'N/log', 'N/search', 'N/url', 'N/runtime', 'N/translation'],
  function(record, log, search, url, runtime, translation) {
    ...
    function beforeLoad(context) {
      if(context.type == "view") {
		...
		context.form.clientScriptModulePath = "SuiteScripts/TSA_Advance_client_scripts.js";
		...
		if(userObj.roleId=="customrole_tsa_cashier" || userObj.roleId=="administrator" || adv_given_to==userObj.id || created_by_user==userObj.id){} else{return;} // ********  EXIT Point - I prefer positive logic in complex condition
