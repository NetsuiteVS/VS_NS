    ...
    function (url, record, log, search, runtime, http, https, translation, file) {
        ...
        function beforeSubmit(scriptContext) {
            ...
            if ( scriptContext.type !== scriptContext.UserEventType.CREATE
          	...
          	var class=scriptContext.newRecord.getValue({ fieldId: 'class' });
          	scriptContext.newRecord.setValue({ fieldId: "custrecord_tsa_class_4_search", value: class, ignoreFieldChange: true });
