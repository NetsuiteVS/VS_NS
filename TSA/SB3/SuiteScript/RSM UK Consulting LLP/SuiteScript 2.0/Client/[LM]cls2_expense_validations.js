...
function(search) {
    ...
    function validateField(scriptContext) {
		...
		if(iouLookUp.custbody32[0].value != recordId){
			alert("IOU is already allocated to an Expense Claim.");
    		scriptContext.currentRecord.getValue({ fieldId : "custbody22", value : null });
    		return false;
		}
		return true;
    }
