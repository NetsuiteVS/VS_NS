...
define(['N/url', 'N/record', 'N/log', 'N/runtime','N/currentRecord', 'N/search', 'N/http' , 'N/https', 'SuiteScripts/vs_lib.js'],
  function(url, record, log, runtime, currentRecord, search, http, https, vs_lib) {
  ...
  //********************** FIELD CHANGED *********************
	function  fieldChanged(context) {
		...
		if(context.fieldId=="foreignamount" && amount!=0 && exchangerate!=0){
			...
			expense_record.setCurrentSublistValue({	sublistId: "expense", fieldId: "amount", value: calc_amount, ignoreFieldChange: true	});
		}
