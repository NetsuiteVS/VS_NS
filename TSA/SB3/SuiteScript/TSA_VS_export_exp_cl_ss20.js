...
//                        ["custcol_cseg_tsa_fundreserv", "noneof", "@NONE@"],
    ...
    //["datecreated","onorafter","16/12/2019 12:00 am"], 
            ...
            var fileHeader = "Type,Document Number,Date Created,Date,Period,Amount,Account,Memo,Memo Main,Reserve,Reserve Source Transaction";
...
/*                        result.columns.forEach(function (col) {
            ...
            if (userId < 1) {
                //log.debug("TSA_VS_export_exp_cl_ss20::execute", 'Set userId to 4145');
                userId = 4145;
            }
