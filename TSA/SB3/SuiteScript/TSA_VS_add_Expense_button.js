  ...
  function(record, log, search, url, runtime, translation) {
    ...
    function beforeLoad(context) {
      if(context.type == "view") {
		...
		if(userObj.roleId=="customrole_tsa_cashier" || adv_given_to==userObj.id || created_by_user==userObj.id){} else{return;} // ********  EXIT Point - I prefer positive logic in complex condition
