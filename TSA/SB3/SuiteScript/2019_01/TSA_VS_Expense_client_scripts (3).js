	...
	if(searchResultCount>0){
      ...
      function lineInit(context) {
          ...
          try {
              ...
              console.log("ExpenseClientScripts3::lineInit Started");

              var category = context.currentRecord.getCurrentSublistValue({ sublistId: 'expense', fieldId: "category" });

              if (category) {
                  window.nlapiDisableLineItemField('expense', "expenseaccount", true);
                  console.log("ExpenseClientScripts3(lineInit)::account disabled=true");
              }
              else {
                  window.nlapiDisableLineItemField('expense', "expenseaccount", false);
                  console.log("ExpenseClientScripts3(lineInit)::account disabled=false");
              }

              console.log("ExpenseClientScripts3::lineInit Finished");
          }
          catch (e) {
              console.log("ExpenseClientScripts3::lineInit Error message=" + e);
          }
          finally {
          }
      }
      ...
      function postSourcing(context) {
          ...
          try {
              ...
              console.log("ExpenseClientScripts3::postSourcing Started");

              console.log("ExpenseClientScripts3:context.fieldId=" + context.fieldId);
              ...
              if (context.fieldId == "category") {
                  ...
                  if (category) {
                      window.nlapiDisableLineItemField('expense', "expenseaccount", true);
                      console.log("ExpenseClientScripts3(fieldChanged)::account disabled=true");
                  }
                  else {
                      window.nlapiDisableLineItemField('expense', "expenseaccount", false);
                      console.log("ExpenseClientScripts3(fieldChanged)::account disabled=false");
                  }
              }

              console.log("ExpenseClientScripts3::postSourcing Finished");
          }
          catch (e) {
              console.log("ExpenseClientScripts3::postSourcing Error message=" + e);
          }
          finally {
          }
      }
