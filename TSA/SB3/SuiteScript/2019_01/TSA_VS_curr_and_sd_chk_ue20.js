    ...
    function (record, log, search, runtime, translation, error, vs_lib) {
        ...
        function beforeSubmit(scriptContext) {
            try {
                ...
                result_str = isThereAnyExitingDefaultIou(accountId, currentCurrencyTxt, currentSubsidiary);
                if (result_str) {
        ...
        function isThereAnyExitingDefaultIou(accountId, currencyTXT, subsidiary) {

            log.debug("curr_and_sd_chk::isThereAnyExitingDefaultIou", "accountId: " + accountId);
            log.debug("curr_and_sd_chk::isThereAnyExitingDefaultIou", "currencyTXT: " + currencyTXT);
            log.debug("curr_and_sd_chk::isThereAnyExitingDefaultIou", "subsidiary: " + subsidiary);
